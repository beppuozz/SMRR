...
int main (int argc, char* argv){
    ...
    CLEP::HepRandom::setTheEngine(new CLEP::MTwistEngine()) //   

    G4RunManager* runManager = new G4RunManager();   

    /*====================Mandatory Initialization Classes====================*/
    G4VUserDetectionConstruction* detector = new DetectorConstruction();
    ...
    G4UserPhysicsList* physics = new QGSP_BERT_HP(); //stesso discorso per DetectorConstruction
    runManager->SetUserInitialization(physics);

    /*====================Mandatory Action Classes====================*/
    G4VUserPrimaryGeneratorAction* gen_action = new PrimaryGeneratorAction();
    runManager->SetUserAction(get_action);
